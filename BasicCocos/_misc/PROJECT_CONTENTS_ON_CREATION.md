...
│   │   └── res
│   ├── _misc
│   │   ├── Changing\ Android\ SDK\ path.PNG
│   │   ├── Choosing\ a\ device\ to\ run\ on.PNG
│   │   ├── Configuring\ Eclipse\ to\ use\ NDK.PNG
│   │   ├── Importing\ libcocos2dx\ as\ an\ Android\ Project.PNG
│   │   ├── Importing\ the\ Android\ project.PNG
│   │   ├── PROJECT-CONTENTS-ON-BUILD-AND-RUN.md
│   │   ├── PROJECT-CONTENTS-ON-CREATION.md
│   │   ├── Project\ Structure\ and\ Contents.PNG
│   │   ├── Run\ as\ an\ Android\ Application.PNG
│   │   ├── Screenshot-on-Android-from-Eclipse.png
